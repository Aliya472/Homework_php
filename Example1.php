...
$rezum = ["Наладчик ТПA",'Техник-технолог','Инженер-технолог',"Инженер-конструктор"];
$rezum_description = ['наладка и ремонт ТПА, установка пресс-форм','Контроль рабочего процесса и соблюдения нормативных параметров','Работа с документацией, чертежами.','Работа с документацией, проектировка чертежей.'];

$Start_time = [2011,2015,2018,2020] ;
$End_time = [2015,2018,2020,'по сей день'] ;
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $rezum[0];?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $Start_time[0] ;?> - <?php echo $End_time[0] ;?></h6>
          <p><?php echo $rezum_description[0];?></p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $rezum[1];?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $Start_time[1] ;?> - <?php echo $End_time[1] ;?></h6>
          <p><?php echo $rezum_description[1];?></p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $rezum[3];?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $Start_time[3] ;?> - <span class="w3-tag w3-teal w3-round"> <?php echo $End_time[3] ;?></span> </h6>
          <p><?php echo $rezum_description[3];?></p><br>
        </div>
      </div>
